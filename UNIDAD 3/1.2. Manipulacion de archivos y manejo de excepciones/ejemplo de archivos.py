...
archivo.write('Añado hoy clase encuentro 24/08/2024 a las 10:47')# Escribe en el archivo
archivo.close()  # Cierra el archivo
...
archivo.write('\nEstamos en Tutoria del 22/28/2024 18:39-- y encuentro') # Añade nueva línea de texto al archivo
archivo.close()
# Cierra el archivo
